	...
	plugins: [
		...
		VitePWA({
			...
			manifest: {
				...
				display: 'standalone',
				description:
				"lunar.js is a powerful node.js module that allows you to interact with the Discord API very easily. It combines both Discord.js and Discord-S.C.U.M into one module",
				icons: [
					{
